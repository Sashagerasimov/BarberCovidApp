...
import com.example.habobooking.Adapter.MyViewPagerAdapter;
import com.example.habobooking.Common.Common;
import com.example.habobooking.Common.NonSwipeViewPager;
...
public class BookingActivity extends AppCompatActivity {
    ...
    private void loadBarberBySalon(String salonID) {
        ...
        //select barber from salon
        ///AllSalon/Sydney/Branch/1qm8MoF5skj0ZFA5EaY8/Barber
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            ...
                            for(QueryDocumentSnapshot barberSnapShot:task.getResult())
                            {
                                ...
                                barber.setPassword("");//dont need pw in client side
                                barber.setBarberId(barberSnapShot.getId());

                                barbers.add(barber);
                            }
                            //send broadcast to 2nd step frag
