...
import com.example.habobooking.Adapter.MyTimeSlotAdapter;
import com.example.habobooking.Common.Common;
import com.example.habobooking.Common.SpacesItemDecoration;
import com.example.habobooking.Interface.ITimeSlotLoadListener;
        ...
        barberDoc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful())
                {
                    ...
                    if(documentSnapshot.exists()) //barbs available
                    {
